...
app.listen(PORT, '0.0.0.0', () => {
    console.log(`🌐 Cortex Bot server listening on port ${PORT}`);
    ...
    XeonBotInc.ev.on('connection.update', async (s) => {
        ...
        if (connection == "open") {
            ...
            await XeonBotInc.sendMessage(botNumber, {
                text: `🤖 Cortex Bot Connected Successfully!\n\n⏰ Time: ${new Date().toLocaleString()}\n✅ Status: Online and Ready!\n\n🔧 Created by: SULEIMAN`
            });

            await delay(1999)
            console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ ${global.botname || 'CORTEX BOT'} ]`)}\n\n`))
            console.log(chalk.cyan(`< ================================================== >`))
            console.log(chalk.magenta(`\n${global.themeemoji || '•'} GITHUB: cortexinvader`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner}`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} CREATOR: SULEIMAN`))
            console.log(chalk.green(`${global.themeemoji || '•'} 🤖 Cortex Bot Connected Successfully! ✅`))
